...
// This is just the controller that receives the midi messages
// It gets instantiated and used in the gui file
// Turn DEBUG mode on there to view debugging midi messages
